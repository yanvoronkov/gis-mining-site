...
// --- OPEN GRAPH ---
$APPLICATION->SetPageProperty("OG:TITLE", "Контейнеры для майнинга от GIS Mining");
$APPLICATION->SetPageProperty("OG:DESCRIPTION", "Майнинг-контейнеры под ключ от компании GIS Mining.");
...
$APPLICATION->SetPageProperty("TWITTER:TITLE", "Контейнеры для майнинга от GIS Mining");
$APPLICATION->SetPageProperty("TWITTER:DESCRIPTION", "Майнинг-контейнеры под ключ от компании GIS Mining.");
