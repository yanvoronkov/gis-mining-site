...
$APPLICATION->SetPageProperty("TITLE", "Инвестиции в строительство дата-центров для майнинга – GIS Mining ");
$APPLICATION->SetTitle("Инвестиции");
// Хлебные крошки теперь формируются автоматически в header
$APPLICATION->SetPageProperty("description", "GIS Mining предлагает инвестиции в создание майнинговых дата-центров и инфраструктуры под ключ. Проектирование, строительство и управление мощностями от 50 до 150 МВт. ");
$APPLICATION->SetPageProperty("robots", "index, follow");

// --- OPEN GRAPH МЕТА-ТЕГИ ---

$APPLICATION->SetPageProperty("OG:TITLE", "Инвестиции в майнинговую инфраструктуру — дата-центры и ЦОДы от GIS Mining");
$APPLICATION->SetPageProperty("OG:DESCRIPTION", "Инвестируйте в строительство дата-центров и площадок под ключ с GIS Mining. Снижение себестоимости до 2,5 ₽ за кВт·ч, гибкие форматы участия, окупаемость от 12 месяцев. Проектирование, строительство и запуск инфраструктуры под майнинг.");
...
$APPLICATION->SetPageProperty("TWITTER:TITLE", "Инвестиции в майнинговую инфраструктуру — дата-центры и ЦОДы от GIS Mining");
$APPLICATION->SetPageProperty("TWITTER:DESCRIPTION", "Инвестируйте в строительство дата-центров и площадок под ключ с GIS Mining. Снижение себестоимости до 2,5 ₽ за кВт·ч, гибкие форматы участия, окупаемость от 12 месяцев. Проектирование, строительство и запуск инфраструктуры под майнинг.");
...
<div class="catalog-page catalog-new container" id="app-root" data-iblock-id="<?= $IBLOCK_ID ?>">
    <h1 class="catalog-page__title section-title highlighted-color">Инвестиции в майнинговую инфраструктуру GIS Mining </h1>
        ...
        <section class="catalog-page__content section-padding">
            ...
            $APPLICATION->IncludeComponent(
                ...
                array(
                    ...
                    "SECTION_URL" => "/catalog/investicii/",
