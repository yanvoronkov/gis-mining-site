...
$APPLICATION->SetPageProperty("TITLE", "Новости — Gis Mining");
...
$APPLICATION->SetPageProperty("OG:TITLE", "Новости — Gis Mining");
...
$APPLICATION->SetPageProperty("TWITTER:TITLE", "Новости — Gis Mining");
...
$blogIblockId = 9; // Здесь нужно указать реальный ID инфоблока blog

// Определяем ID инфоблока blog
$iblock = CIBlock::GetList(
    array("SORT" => "ASC"),
    array("CODE" => "news", "ACTIVE" => "Y")
)->GetNext();
