	...
	<div class="container">
		...
		<div class="footer__top">
			<div class="footer__main-info">
				<a href="/" class="logo footer__logo">
					...
					<img src="<?= SITE_TEMPLATE_PATH ?>/assets/img/footer/logo_footer_dark.png" alt="GIS Mining - Логотип компании" width="313" height="46">
				</a>
        ...
        <div class="page-asics__popup-form popup-form-wrapper js-cart-modal" id="cartPopupFormWrapper" style="display: none;">
            ...
            <form class="popup-form js-ajax-form" id="cartForm" data-metric-goal="send-cart-lead">
              ...
              <label for="privacy-policy-footer" class="form-check-label">Согласен(а) с <a href="/policy-confidenciales/" target="_blank"><u>политикой конфиденциальности</u></a></label>
            </div>
...
<div class="page-business__popup-form popup-form-wrapper js-cart-modal" id="rassrochkaPopupFormWrapper" style="display: none;">
    ...
    <form class="popup-form js-ajax-form" id="rassrochka_form" data-metric-goal="send-rassrochka-lead">
        ...
        <div class="form-group form-check mb-3">
              ...
              <label for="privacy-policy" class="form-check-label">Согласен(а) с <a href="/policy-confidenciales/" target="_blank"><u>политикой конфиденциальности</u></a></label>
            </div>
...
">
    <div style="display: flex; align-items: flex-start; justify-content: space-between; gap: 15px; flex-wrap: wrap;">
        <div style="
            ...
            color: #333;
        ">
            Мы используем <a href="/policy-confidenciales/" target="_blank" style="color:#5b61ff;text-decoration:underline;">файлы cookie</a>, 
