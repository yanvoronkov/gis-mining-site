					...
					if(isset($arItem["PRICE"])):
						...
						<div class="<?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?>col-sm-6 col-md-4<?else:?>col-12<?endif?> mb-2 smart-filter-parameters-box bx-active">
							<div class="smart-filter-parameters-box-title" onclick="smartFilter.hideFilterProps(this)">
								...
								<span class="smart-filter-parameters-box-title-text catalog-filter__group-toggle"><?=$arItem["NAME"]?></span>
								<span data-role="prop_angle" class="smart-filter-angle smart-filter-angle-up">
									<svg class="icon-arrow" width="12" height="7" viewBox="0 0 12 7" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path d="M11 1.12695L6.07071 6.05624C6.03166 6.0953 5.96834 6.0953 5.92929 6.05624L1 1.12695" stroke="#131315" stroke-linecap="round"></path>
									</svg>
								</span>
							</div>
			...
			<div class="row">
				<div class="col smart-filter-button-box">
					<div class="smart-filter-block">
						<div class="smart-filter-parameters-box-container">
							<input
								class="btn btn-primary btn-primary catalog-filter__apply-btn"
								type="submit"
								id="set_filter"
								name="set_filter"
								value="<?=GetMessage("CT_BCSF_SET_FILTER")?>"
												>
							<input
								class="btn btn-link btn btn-secondary catalog-filter__reset-btn"
								type="submit"
								id="del_filter"
								name="del_filter"
								value="<?=GetMessage("CT_BCSF_DEL_FILTER")?>"
												>
							<div class="smart-filter-popup-result <?if ($arParams["FILTER_VIEW_MODE"] == "VERTICAL") echo $arParams["POPUP_POSITION"]?>" id="modef" style="<?if(!isset($arResult["ELEMENT_COUNT"])) echo 'display:none;'; else echo 'display: inline-block;';?>">
