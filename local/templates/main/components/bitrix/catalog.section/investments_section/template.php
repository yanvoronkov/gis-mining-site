<?php
/**
 * Шаблон компонента catalog.section для раздела "Инвестиции"
...
<?php if (!empty($arResult["ITEMS"])): ?>
    <div class="product-grid investicii__product-grid">
        <?php foreach ($arResult["ITEMS"] as $arItem): ?>
            ...
            <div class="product-card investicii-product-card" 
                ...
                <div class="product-card__info">
                    ...
                    <?php endif; ?>
                    <?php if (!empty($arItem["PROPERTIES"]["INVEST_COMPLETION_DATE"]["VALUE"])): ?>
                    <div class="product-card__property-item">
                        <p class="product-card__numofdev-name">Срок сдачи объекта</p>
                        <p class="product-card__numofdev-value"><?= htmlspecialchars($arItem["PROPERTIES"]["INVEST_COMPLETION_DATE"]["VALUE"]) ?></p>
                    </div>
                    <?php endif; ?>
                    <?php if (!empty($arItem["PROPERTIES"]["INVEST_TYPE"]["VALUE"])): ?>
                    <div class="product-card__property-item">
                        <p class="product-card__numofdev-name">Тип</p>
                        <p class="product-card__numofdev-value"><?= htmlspecialchars($arItem["PROPERTIES"]["INVEST_TYPE"]["VALUE"]) ?></p>
                    </div>
                    <?php endif; ?>
                    <?php if (!empty($arItem["PROPERTIES"]["INVEST_NUM_OF_DEVICES"]["VALUE"])): ?>
                    <div class="product-card__property-item">
                        <p class="product-card__numofdev-name">Количество устройств</p>
                        <p class="product-card__numofdev-value"><?= htmlspecialchars($arItem["PROPERTIES"]["INVEST_NUM_OF_DEVICES"]["VALUE"]) ?></p>
                    </div>
                    <?php endif; ?>
