<?php
/**
 * Шаблон компонента catalog.section для раздела "Контейнеры"
...
<?php if (!empty($arResult["ITEMS"])): ?>
    <div class="product-grid conteynery__product-grid">
        <?php foreach ($arResult["ITEMS"] as $arItem): ?>
            ...
            <div class="product-card conteynery-product-card" 
                ...
                <div class="product-card__info">
                    ...
                    <?php endif; ?>
                    <?php if (!empty($arItem["PROPERTIES"]["CONTAINERS_NUMBER_OF_PLACES"]["VALUE"])): ?>
                    <div class="product-card__property-item">
                        <p class="product-card__numofdev-name">Количество мест</p>
                        <p class="product-card__numofdev-value"><?= htmlspecialchars($arItem["PROPERTIES"]["CONTAINERS_NUMBER_OF_PLACES"]["VALUE"]) ?></p>
                    </div>
                    <?php endif; ?>
                    <?php if (!empty($arItem["PROPERTIES"]["CONTAINERS_POWER"]["VALUE"])): ?>
                    <div class="product-card__property-item">
                        <p class="product-card__numofdev-name">Общая мощность, кВт</p>
                        <p class="product-card__numofdev-value"><?= htmlspecialchars($arItem["PROPERTIES"]["CONTAINERS_POWER"]["VALUE"]) ?></p>
                    </div>
                    <?php endif; ?>
                    <?php if (!empty($arItem["PROPERTIES"]["CONTAINERS_COOLING_SYSTEM"]["VALUE"])): ?>
                    <div class="product-card__property-item">
                        <p class="product-card__numofdev-name">Система охлаждения</p>
                        <p class="product-card__numofdev-value"><?= htmlspecialchars($arItem["PROPERTIES"]["CONTAINERS_COOLING_SYSTEM"]["VALUE"]) ?></p>
                    </div>
                    <?php endif; ?>
