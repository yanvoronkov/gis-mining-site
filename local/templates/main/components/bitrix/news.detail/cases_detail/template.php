    ...
    <div class="page-blog-detail__block">
        <div class="page-blog-detail__article">
            ...
            <div class="contact-form-section">
                ...
                <form class="contact-form js-ajax-form" data-metric-goal="cases-contact-form">
                    ...
                    <!-- Скрытые поля -->
                    <input type="hidden" name="form_name" value="Контактная форма кейсов">
            ...
            <div class="page-blog-detail__filter-buttons">
                ...
                if ($sections) {
                    while ($section = $sections->GetNext()):
                        ?>
                        <a href="/cases/?SECTION_ID=<?= $section["ID"] ?>" class="page-blog-detail__filter-btn">
                            <?= $section["NAME"] ?>
                        </a>
                        <?php
                    endwhile;
