...
if(  Loader::includeModule('dwstroy.seochpulite') ){
    ...
    $apl->IncludeComponent(
        "dresscode:catalog.smart.filter", $this->__templateName, $arParams, $this->__parent
    );
    Helper::clearGet();
    ...
    include($_SERVER['DOCUMENT_ROOT'].'/bitrix/components/dresscode/catalog.smart.filter/component.php');
}
