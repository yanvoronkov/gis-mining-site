...
if (empty($elementCode)) {
    ...
    $elementCode = str_replace('/smi-o-nas/', '', $elementCode);
...
$blogIblockId = 10; // Используем ваш ID напрямую
...
<?php if ($article): ?>
    ...
    $APPLICATION->IncludeComponent(
        ...
        array(
            ...
            "ELEMENT_CODE" => $_REQUEST["ELEMENT_CODE"], // тут всё придёт само из ЧПУ
            "CHECK_DATES" => "Y",
            "SET_TITLE" => "N",
...
<?php else: ?>
    <div class="article-not-found">
        ...
        <a href="/smi-o-nas/" class="back-to-blog">← Вернуться к блогу</a>
    </div>
